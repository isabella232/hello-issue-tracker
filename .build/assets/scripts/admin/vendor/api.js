...
import type {ApiFetchData, ApiFetchMethod} from "./types";

export const doApi: Function = (path: string, data: ApiFetchData = {}, method: ApiFetchMethod = 'GET') => {
    ...
    const url: string = config.gitlab.repoUrl + path + '?' + urlParams.join('&');
