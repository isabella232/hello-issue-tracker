...
var _settings = __webpack_require__(232);
...
var _entries = __webpack_require__(233);
...
var _slicedToArray2 = __webpack_require__(237);
...
var do_api = exports.do_api = function do_api(path) {
...
var parse_issue = exports.parse_issue = function parse_issue(obj) {
	...
	try {
		for (var _iterator2 = (0, _getIterator3.default)(obj.labels), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
...
var templateIssueMain = exports.templateIssueMain = function templateIssueMain(issue) {
	...
	var showdown = __webpack_require__(19);
...
var _regenerator = __webpack_require__(210);

var _regenerator2 = _interopRequireDefault(_regenerator);

var _asyncToGenerator2 = __webpack_require__(213);
...
var _issueList = __webpack_require__(58);

var _issueMain = __webpack_require__(182);

var _issueEdit = __webpack_require__(183);
...
(function ($) {
	$(function () {
					...
					while (1) {
						switch (_context4.prev = _context4.next) {
							...
							case 8:
								...
								_context4.prev = 13;
								for (_iterator2 = (0, _getIterator3.default)(issues); !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
									value = _step2.value;
		...
		$page.on('click', '.js-hit-close-issue', (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2() {
			var iid, issue;
				...
				while (1) {
					switch (_context2.prev = _context2.next) {
						case 0:
							...
							if (!(typeof iid === 'undefined' || !_settings.plugin.repo)) {
								_context2.next = 3;
								break;
							}
						...
						case 5:
							_context2.next = 7;
							return (0, _api.do_api)('projects/' + _settings.plugin.repo + '/issues/' + iid, {
								state_event: 'close'
							}, 'PUT');
		...
		function set_main(iid) {
			...
			(0, _api.load_comments)(iid).then(function (resp) {
				...
				try {
					for (var _iterator = (0, _getIterator3.default)(resp), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
						var comment = _step.value;

						if ((typeof comment === 'undefined' ? 'undefined' : (0, _typeof3.default)(comment)) !== 'object' || comment.system) {
							continue;
						}
